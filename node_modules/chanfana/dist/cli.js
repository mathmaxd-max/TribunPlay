...
var resolvedOutputFile = (0, import_node_path.join)(process.cwd(), outputFile);
var outputDir = (0, import_node_path.dirname)(resolvedOutputFile);
var childProcess = (0, import_node_child_process.spawn)("npx", wranglerArgs, {
  cwd: process.cwd(),
    ...
    if (match?.[1]) {
      ...
      try {
        ...
        try {
          ...
          await (0, import_promises.writeFile)(resolvedOutputFile, schemaString);
