...
export function encodeAttackTribun(attackerCid: number): number {
...
// END: opcode 11
export function encodeEnd(endReason: number, winnerColor?: Color): number {
    ...
    case 0: // MOVE
      {
        ...
        if (part === 0) {
          ...
          const movedUnit: Unit = { ...fromUnit, s: 0 }; // Leave secondary behind
